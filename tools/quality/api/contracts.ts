...
const SEMANTIC_ALIASES: Readonly<Record<string, string>> = {
  ...
  camelCase: "normalization.camel-case",
  toCamelCase: "normalization.camel-case",
  pascalCase: "normalization.pascal-case",
  toPascalCase: "normalization.pascal-case",
  snakeCase: "normalization.snake-case",
  toSnakeCase: "normalization.snake-case",
  kebabCase: "normalization.kebab-case",
  toKebabCase: "normalization.kebab-case",
  upperSnakeCase: "normalization.upper-snake-case",
  toUpperSnakeCase: "normalization.upper-snake-case",
};
