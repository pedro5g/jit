 ...
 */
export function inspect_token(token: string): any;
 ...
 */
export function pack_typescript(files: any, output_root: string): any;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly inspect_token: (a: number, b: number, c: number) => void;
    readonly pack_typescript: (a: number, b: number, c: number, d: number) => void;
