...
export const SYNONYMS: Record<string, string[]> = {
  ...
  especializado: ["specialized", "specialization", "compile"],
  especializada: ["specialized", "specialization", "compile"],
  especializacao: ["specialization", "specialized", "compile"],
  especialização: ["specialization", "specialized", "compile"],
  funciona: ["works", "execution", "compile"],
  funcionamento: ["works", "execution", "compile"],
  direto: ["direct", "property", "access"],
  direta: ["direct", "property", "access"],
  propriedade: ["property", "field", "access"],
  propriedades: ["property", "field", "access"],
  indexado: ["indexed", "loop", "array"],
  indexados: ["indexed", "loop", "array"],
  somente: ["only", "unused", "absent"],
  exigidas: ["required", "checks", "validation"],
