...
This lowers to one generated execution function. It calls native `JSON.parse`
and immediately invokes the schema-specific validator; see
[composable execution](/docs/runtime/composable-execution) for the physical
fusion boundaries.
