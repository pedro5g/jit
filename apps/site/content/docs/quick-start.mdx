...
The final callable lowers the whole descriptor once. Supported JSON schemas
decode and validate in one generated token traversal; adjacent query stages
share one indexed loop. Add `.transform(target, fields)`,
