...
related: /docs/runtime/dtos, /docs/reference/functions/mask, /docs/runtime/validation
---
...
const parse = JIT.json.parse(CreateUser).validate();
...
const toPublic = JIT.map.many(User, PublicUser, {});

return Response.json(toPublic(users));
```
