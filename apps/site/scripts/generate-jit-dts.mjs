...
// gets full type inference for `import { JIT } from "@jit-compiler/jit/runtime"`.
...
if (count === 0) {
  console.error(
    "[jit-dts] no .d.ts files found - build the jit package first (pnpm --filter @jit-compiler/jit build)",
  );
  process.exit(1);
}
