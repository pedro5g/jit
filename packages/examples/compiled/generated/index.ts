...
// @ts-nocheck -- generated internals are typed at the public export boundary.
...
export type PublicUser = { id: number; name: string; role: "admin" | "member" };
...
const Users_is_validator = /*#__PURE__*/ (() => {
...
const Users_is = /*#__PURE__*/ ((v) => v.is)(Users_is_validator);
const Users_parse_validator = /*#__PURE__*/ (() => {
  const __v0 = /^(?:[A-Za-z0-9_'+-]+\.)*[A-Za-z0-9_'+-]*[A-Za-z0-9_+-]@(?:[A-Za-z0-9][A-Za-z0-9-]*\.)+[A-Za-z]{2,}$/;
  const __v1 = /^(?:(?:\d\d[2468][048]|\d\d[13579][26]|\d\d0[48]|[02468][048]00|[13579][26]00)-02-29|\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\d|30)|(?:02)-(?:0[1-9]|1\d|2[0-8])))T(?:(?:[01]\d|2[0-3]):[0-5]\d(?::[0-5]\d(?:\.\d+)?)?(?:Z))$/;
  const __v2 = /<(script|style|iframe|object|embed)[^>]*>[\s\S]*?<\/\1\s*>/gi;
  const __v3 = /<[^>]*>/g;
...
const Users_parse = (value) => { const r = Users_parse_validator.safeParse(value); if (r.success) return r.data; throw new JITValidationError(r.issues); };
const Users_safeParse_validator = /*#__PURE__*/ (() => {
  const __v0 = /^(?:[A-Za-z0-9_'+-]+\.)*[A-Za-z0-9_'+-]*[A-Za-z0-9_+-]@(?:[A-Za-z0-9][A-Za-z0-9-]*\.)+[A-Za-z]{2,}$/;
  const __v1 = /^(?:(?:\d\d[2468][048]|\d\d[13579][26]|\d\d0[48]|[02468][048]00|[13579][26]00)-02-29|\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\d|30)|(?:02)-(?:0[1-9]|1\d|2[0-8])))T(?:(?:[01]\d|2[0-3]):[0-5]\d(?::[0-5]\d(?:\.\d+)?)?(?:Z))$/;
  const __v2 = /<(script|style|iframe|object|embed)[^>]*>[\s\S]*?<\/\1\s*>/gi;
  const __v3 = /<[^>]*>/g;
...
const Users_safeParse = /*#__PURE__*/ ((v) => v.safeParse)(Users_safeParse_validator);
const Users_equal = (function equal(l, r) {
  if (l === r) {
    return true;
  }
...
const Users_clone = (function clone(value) {
...
const Users_hash_hash = /*#__PURE__*/ (() => {
...
const Users_hash = Users_hash_hash;
const Users_stringify = ((function () {
  const __se = /[\u0000-\u001f\u0022\u005c\ud800-\udfff]/;
  function str(value) {
...
const Users_fromJSON_validator = /*#__PURE__*/ (() => {
  const __v0 = /^(?:[A-Za-z0-9_'+-]+\.)*[A-Za-z0-9_'+-]*[A-Za-z0-9_+-]@(?:[A-Za-z0-9][A-Za-z0-9-]*\.)+[A-Za-z]{2,}$/;
  const __v1 = /^(?:(?:\d\d[2468][048]|\d\d[13579][26]|\d\d0[48]|[02468][048]00|[13579][26]00)-02-29|\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\d|30)|(?:02)-(?:0[1-9]|1\d|2[0-8])))T(?:(?:[01]\d|2[0-3]):[0-5]\d(?::[0-5]\d(?:\.\d+)?)?(?:Z))$/;
  const __v2 = /<(script|style|iframe|object|embed)[^>]*>[\s\S]*?<\/\1\s*>/gi;
  const __v3 = /<[^>]*>/g;
...
const Users_fromJSON = (json) => { const r = Users_fromJSON_validator.safeParse(JSON.parse(json)); if (r.success) return r.data; throw new JITValidationError(r.issues); };
const Users_mask = (function scrub(value) {
...
const Users_mock = (function mock(options) {
  __srand(options && options.seed !== undefined ? options.seed : (Math.random() * 2147483647) | 0);
  return { id: __int(1, 1000), name: __chars(__ALPHA, __int(3, 80)), email: __email(), role: (() => { switch (__int(0, 1)) { case 0: return "admin"; case 1: return "member"; } })(), active: __rand() < 0.5, score: (0 + __rand() * 100), tags: Array.from({ length: __int(1, 8) }, () => (__chars(__ALPHA, __int(2, 12)))), createdAt: __isoDate(1600000000000, 1900000000000), profile: (__rand() < 0.5 ? undefined : { bio: (__rand() < 0.25 ? null : __chars(__ALPHA, __int(3, 12))) }) };
});
const Users: {
  readonly is: (value: unknown) => value is User;
  readonly parse: (value: unknown) => User;
  readonly safeParse: (value: unknown) => { readonly success: true; readonly data: User } | { readonly success: false; readonly issues: readonly { readonly path: readonly PropertyKey[]; readonly code: string; readonly expected: string; readonly message: string; readonly received?: string }[] };
  ...
  readonly mock: (options?: { readonly seed?: number }) => User;
} = /*#__PURE__*/ Object.freeze({
  is: Users_is,
  parse: Users_parse,
  safeParse: Users_safeParse,
  equal: Users_equal,
  clone: Users_clone,
  diff: Users_diff,
  hash: Users_hash,
  stringify: Users_stringify,
  fromJSON: Users_fromJSON,
  mask: Users_mask,
  sanitize: Users_sanitize,
  codec: Users_codec,
  mock: Users_mock,
});
